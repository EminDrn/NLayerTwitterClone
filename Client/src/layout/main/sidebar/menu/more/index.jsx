...
export default function More(){
    return(
      ...
      <Disclosure.Panel className="text-gray-500">
        <Link to='/' className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-white transition-colors   hover:bg-[#eff3f41a]">
        <svg viewBox="0 0 24 24" width={18.75} height={18.75} >
                  <path 
                  fill="#e7e9ea"
    ...
    <Disclosure>
      ...
      <Link to='/' className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-white transition-colors   hover:bg-[#eff3f41a]">
        ...
        <svg viewBox="0 0 24 24" width={18.75} height={18.75} >
                  <path 
                  fill="#e7e9ea"
                  d="M 14 12 c 0 -1.1 -0.9 -2 -2 -2 c -1.11 0 -2 0.9 -2 2 v 2 h 2 c 1.1 0 2 -0.9 2 -2 Z"/>
